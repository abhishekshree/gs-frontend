...
export default function Sidebar({ openModal, setOpenModal }) {
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li className="items-center">
                <div onClick={handleLogOut}>
                  <Link
                    className="text-xs uppercase py-3 font-bold block text-red-500 hover:text-red-700"
                    to="/"
                  >
                    Log Out
                  </Link>
