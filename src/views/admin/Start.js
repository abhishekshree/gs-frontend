...
export default function Start() {
  ...
  const handleUploadClick = async () => {
    ...
    const destinationsData = new FormData();
                ...
                {(!loading)
                  && (
                    <>
                      ...
                      <h4
                        className="text-2xl font-semibold text-center uppercase"
                        style={{
                          margin: 'auto', width: '70%', paddingTop: '10px', paddingBottom: '10px', backgroundColor: '#445a70', color: '#dde5ed', borderRadius: '8px',
                        }}
                      >
                        Set Deliveries
                      </h4>
