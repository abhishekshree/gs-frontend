...
export default function Admin(props) {
  ...
  const handleLoadDriver = (driverId) => {
    if (!driverId)
      return
        ...
        <div className="w-full h-1/6">
          ...
          <div>
            ...
            <div class="p-2 flex">
              ...
              <button className="bg-lightBlue-500 text-white active:bg-lightBlue-600 font-bold uppercase text-sm px-6 py-3 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150 w-1/4 ml-auto" type="button" onClick={() => handleLoadDriver(driverId)}>
                Show
              </button>
            </div>
            }
