    ...
    <main>
      <section className="absolute w-full h-full min-h-screen content-center">
        <div
          ...
          style={{
            backgroundHeight: 'auto', backgroundImage: 'url(https://i.ibb.co/Ry5PmDt/login-background.png)', backgroundRepeat: 'repeat-y', backgroundColor: '#708090',
          }}
          // style={{ backgroundColor: '#89a1b4' }}
        >
          <div className="container pt-1 h-14  px-4 content-center  place-self-center ">
            <span className="text-center bg-indigo-500" style={{ width: '20%' }}>
              <h1
                className="text-5xl bold leading-normal mt-10 mb-0 text-blueGray-200 "
                style={{
          ...
          <div className="container h-12 mx-auto h-full w-full pt-28">
            <div className="flex justify-center h-full w-full items-center">
              {/* <div className="w-6/12 px-12">
                <img src="https://cdn139.imgdb.in/kJzb.jpg" alt="logo" />
              </div> */}
              <div className=" w-full lg:w-4/12 ">
                <div
                  className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0 place-self-center content-center"
